...
class TestHarvester:
    ...
    def test_query_data(self, mocked_earthdata, mocked_copernicus, config_file):  # pylint:disable=unused-argument
    ...
    @patch("noaharvester.harvester.copernicus.Copernicus")
    @patch("noaharvester.harvester.earthdata.Earthdata")
    def test_download_data(self, mocked_earthdata, mocked_copernicus, config_file):  # pylint:disable=unused-argument
    ...
    @patch("noaharvester.harvester.copernicus.Copernicus")
    @patch("noaharvester.harvester.earthdata.Earthdata")
    def test_describe(self, mocked_earthdata, mocked_copernicus, config_file):  # pylint:disable=unused-argument
    ...
    def test_resolve_instances(
        ...
        harvester = Harvester(config_file)
        harvester._resolve_provider_instance("earthdata")  # pylint:disable=protected-access
        harvester._resolve_provider_instance("copernicus")  # pylint:disable=protected-access
